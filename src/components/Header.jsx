    ...
    <>
      <nav className="navbar navbar-expand-lg navbarcolor  sticky-top">
        <div className="container-fluid">
          <Link to="/" className="nav-link active" aria-current="page" href="/"> <img src="/dfsklogo.png" alt="Logo" className="" width="80" /></Link>
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <div className="mx-2 my-2">
              <button className="btn btn-outline-success rounded-5" type="button" title="Cerrar Sesión">
